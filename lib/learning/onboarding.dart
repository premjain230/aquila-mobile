...
final List<OnboardingQuestion> onboardingQuestions = [
  ...
  OnboardingQuestion(id: 'competitiveExam', tier: 1, field: 'goals.competitiveExam', question: 'Which competitive exam?', input: 'single', options: const ['JEE','NEET','UPSC','Olympiad','Other'], next: (a, all) => 'subjects'),
